...
const ItemCard = ({ product }: { product: ProductData }) => {
    return (
        <a href={product.link} className="">
            <div className="m-1 flex flex-col rounded-md shadow-md border border-gray-900 hover:opacity-95 transition-all max-h-[600px] justify-around w-[300px]  bg-primaryLight max-w-full">
